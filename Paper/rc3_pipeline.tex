...
%    Imaging Technique         & CCD           & Infared array      & \footnotesize{Photographic Plates} \\ \hline
%    
%    \end{tabular}
%    
%%\end{table}

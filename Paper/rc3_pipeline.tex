...
There are a total of 12512 RC3 galaxies within the SDSS footprint. The mosaicing was  successful for 90.22\% of the galaxies. 2446 RC3 galaxies is mosaiced using updated positions that were more than 1 arcminute off the values recorded in the RC3 catalog.  On <bigdog specs>  machine, the program processes on average about 80 RC3 objects per hour using SDSS data.  %1.21 galaxies per minute, 

<html>
 ...
 <?php
    ...
    if ($pgc=='' and $sql==''){ #is_null doesn't work
		...
		{ 
			//echo htmlspecialchars($row->PGC)."</br>";
			//echo htmlspecialchars($row->low)."</br>"; 
...
echo "Note: Query result of RC3 galaxies are based updated position values instead of values recorded in the RC3 Catalog";
		...
		{  
			...
			//echo "<td><a href='/Library/WebServer/Documents/data/rc3/search.html' target='_blank'>Download</a></td>";
//			$pieces = explode("/", htmlspecialchars($row->best));
			echo "<td><a href='".htmlspecialchars($row->low)."' target='_blank'>".explode("/", htmlspecialchars($row->low))[2]."</a></td>";
			echo "<td><a href='".htmlspecialchars($row->best)."' target='_blank'>".explode("/", htmlspecialchars($row->best))[2]."</a></td>";
			echo "<td><a href='".htmlspecialchars($row->ufits)."' target='_blank'>".explode("/", htmlspecialchars($row->ufits))[2]."</a></td>";
			echo "<td><a href='".htmlspecialchars($row->gfits)."' target='_blank'>".explode("/", htmlspecialchars($row->gfits))[2]."</a></td>";
			echo "<td><a href='".htmlspecialchars($row->rfits)."' target='_blank'>".explode("/", htmlspecialchars($row->rfits))[2]."</a></td>";
			echo "<td><a href='".htmlspecialchars($row->ifits)."' target='_blank'>".explode("/", htmlspecialchars($row->ifits))[2]."</a></td>";
 			echo "<td><a href='".htmlspecialchars($row->zfits)."' target='_blank'>".explode("/", htmlspecialchars($row->zfits))[2]."</a></td>";
			echo "</tr>";
